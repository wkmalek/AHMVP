...
namespace AHWForm.Models
{
    public class AuctionDetailsModel : IAuctionDetailsModel
    {
        ...
        public AuctionDetailsViewModel LoadAuction(string ID, string currency, ICurrencyExchangeRepository currencyExchangeRepository, string username)
        {
            ...
            return new AuctionDetailsViewModel(auction, bidsVM, img, username);   
        }
    }
    ...
    public class AuctionDetailsViewModel : SingleAuctionViewModel
    {
        ...
        public AuctionDetailsViewModel(AuctionModel auc, IAuctionBidsViewModel bid, List<ImagesModel> img, string userName)
        {
